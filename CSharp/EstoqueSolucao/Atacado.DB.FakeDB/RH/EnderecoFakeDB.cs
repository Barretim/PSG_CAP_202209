...
namespace Atacado.DB.FakeDB.RH
{
    public static class EnderecoFakeDB
    {
        ...
        {
            enderecos.Add(new Endereco(1, "Rua São José", 162, "Casa", "Centro", "30120060", "Belo Horizonte", "MG"));
            enderecos.Add(new Endereco(2, "Rua Tamandare", 280, "Apartamento", "Boa Viagem", "30130005", "Belo Horizonte", "MG"));
